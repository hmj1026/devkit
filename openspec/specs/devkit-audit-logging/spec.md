# devkit-audit-logging Specification

## Purpose
Strategy-based Eloquent entity-change logger with pluggable log targets (DB / Elasticsearch) and login-event capture via jenssegers/agent.
