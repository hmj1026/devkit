# devkit-googlechat-logger Specification

## Purpose
Monolog 2.9 handler for Google Chat webhooks with color-coded severity cards, per-level user mentions, and a Laravel custom-log-driver bridge.
