# devkit-http-gateway Specification

## Purpose
Single-class Guzzle gateway with retry / exponential backoff / log observers — subclassable for per-API typed wrappers, no separate Request/Response hierarchies.
