# devkit-sms-dispatch Specification

## Purpose
SMS driver contract + manager with named drivers, NullDriver for dev/test, AbstractHttpSmsDriver subclass base, and a Laravel notification-channel/queueable-job bridge.
