# devkit-enum Specification

## Purpose
Reflection-based AbstractEnum base class with memoised constants, alias lookup, and display-content mapping — pure PHP, no Illuminate dependency.
