# devkit-blade-helpers Specification

## Purpose
Pure-PHP breadcrumb Trail and weight-sorted Meta tag manager (wrapping butschster/meta-tags ^2.1 or ^3.0), with Laravel facades/helpers/Blade directives.
